 ...
 * backup/system-path-tools/drive_ops.ts
 * 
...
export async function stubTool(...args: any[]): Promise<string> {
  return JSON.stringify({
    ...
    hint: 'Restore from backup/system-path-tools/drive_ops.ts when sandbox permissions are updated.',
